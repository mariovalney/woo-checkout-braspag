<?php
/**
 * The Template for Eletronic Transfer payment in Braspag
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/braspag/payment-methods/et-form.php.
 *

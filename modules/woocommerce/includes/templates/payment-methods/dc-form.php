<?php
/**
 * The Template for Debit Card payment in Braspag
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/braspag/payment-methods/dc-form.php.
 *
